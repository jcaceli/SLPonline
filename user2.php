  ...
  <div class="modal fade" id="uploadprofile" role="dialog">
    <div class="modal-dialog">
      ...
      <div class="modal-content" style="padding:1em" id="upprof">
		...
		<!--	<label for="FileInput">
			<img src="imgs/cam.png" width="18" height="18" style="cursor:pointer" onmouseover="this.src='imgs/cam.png'" onmouseout="this.src='imgs/cam.png'" alt="Upload" style="float:right;margin:7px" >
			</label> -->
